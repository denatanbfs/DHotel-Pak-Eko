...
<html>
  ...
  <body class="grey lighten-5">
    ...
    <div class="container">
            <h2 class="mt-3 center-align">Rincian Belanja Anda</h2>
            ...
            <div class="row center-align">
                ...
                <div class="center-align">
                <a href="action/payment.php?id=<?=$id_user?>" class="btn btn-success modal-trigger" style="width: 40%; height: 60px; font-size: 25px; padding-top: 12px;">Bayar</a>
                </div>
